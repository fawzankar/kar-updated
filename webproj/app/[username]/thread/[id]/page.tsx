...
export default function SharedThreadPage() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/messages?view=thread&id=${encodeURIComponent(id)}&to=${encodeURIComponent(username || 'fowzan')}`, { cache: 'no-store' })
      .then(async (response) => {
