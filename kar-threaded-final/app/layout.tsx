...
export const metadata: Metadata = {
  title: "Fowzan Kar — Anonymous Messages",
  description: 'Send Fowzan Kar an anonymous question, thought, or reply.',
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'),
  openGraph: {
    title: "Fowzan Kar",
    description: 'Send an anonymous message to Fowzan Kar.',
    type: 'website',
  },
  twitter: {
    card: 'summary',
