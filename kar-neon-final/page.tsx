  ...
  return (
    <main className={`funky-page scene-${ambientScene} min-h-screen px-5 py-6 text-foreground sm:px-8`}>
      ...
      <header className="relative z-10 mx-auto flex max-w-4xl items-center justify-between">
        <div className="brand-mark"><span>Fowzan Kar</span></div>
      ...
      <section className="relative z-10 mx-auto max-w-4xl pb-16 pt-14 sm:pt-24">
        <div className="identity-row">
          <div className="avatar funky-avatar" aria-hidden="true">01</div>
          <div>
            <div className="eyebrow"><Sparkles size={13} /> anonymous messages</div>
            <p className="mt-2 text-sm text-muted-foreground">Ask Fowzan anything. Say what you actually mean. Stay anonymous if you want.</p>
          </div>
        </div>
        ...
        <div className="hero-copy">
          <div>
            ...
            <p className="hero-line">A low-key place to ask, confess, joke around, or say the thing you would not say out loud.</p>
          </div>
        ...
        <div className="question-box mt-10 w-full text-left">
          ...
          <div className="message-shell funky-shell">
            <textarea value={thought} onChange={(event) => setThought(event.target.value)} placeholder="drop your message here..." rows={5} maxLength={500} aria-label="Your anonymous message" />
        ...
        <div className="prompt-deck mt-8">
          <div className="section-kicker"><Sparkles size={13} /> need an idea?</div>
      ...
      <section className="responses-section relative z-10 mx-auto max-w-4xl border-t border-border/70 pb-24 pt-16">
        <div className="flex items-end justify-between gap-4">
          <div>
            <div className="section-kicker"><MessageCircle size={14} /> open threads</div>
            <h2 className="mt-3 font-serif text-4xl tracking-[-0.04em]">Open <span>threads.</span></h2>
            <p className="mt-3 max-w-sm text-sm leading-6 text-muted-foreground">Questions Fowzan has opened up for conversation. Jump in without an account.</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="mt-8 space-y-4">
            ...
            {!responses.length && <div className="empty-note">No open threads yet. Start one by asking a question.</div>}
          </div>
        )}
      </section>
