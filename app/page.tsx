...
export default function Page() {
  ...
  return (
    <main className="app-page public-page" data-theme={theme}>
      ...
      <section className="public-threads page-width"><div className="threads-heading"><div><div className="eyebrow"><MessageCircle size={13} /> FOWZAN&apos;S REPLIES</div><h2>REPLY BOARD.</h2><p>Whatever Fowzan chooses to reply to will appear here.</p><small className="thread-contribute-hint">You could contribute in the thread too.</small></div><span>{responses.length} live</span></div>
